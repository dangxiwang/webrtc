...
struct LossBasedControlConfig {
  ...
  FieldTrialParameter<double> loss_forget_per_sec;
  FieldTrialParameter<double> loss_max_forget_per_sec;
  FieldTrialParameter<double> acknowledged_rate_max_forget_per_sec;
  ...
  FieldTrialParameter<double> loss_bandwidth_rule_exponent;
...
class LossBasedBandwidthEstimation {
 public:
  ...
  void UpdateLossStatistics(float last_fraction_loss, Timestamp at_time);
