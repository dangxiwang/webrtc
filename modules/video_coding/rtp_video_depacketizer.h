...
#ifndef MODULES_VIDEO_CODING_RTP_VIDEO_DEPACKETIZER_H_
#define MODULES_VIDEO_CODING_RTP_VIDEO_DEPACKETIZER_H_
...
class RtpVideoDepacketizer {
 public:
  ...
  virtual absl::optional<Frame> AssembleFrame(
      size_t num_packets,
      rtc::FunctionView<const RtpPacketReceived&(size_t index)> packets) = 0;
};

}  // namespace webrtc

#endif  // MODULES_VIDEO_CODING_RTP_VIDEO_DEPACKETIZER_H_
