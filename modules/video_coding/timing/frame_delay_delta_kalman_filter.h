...
//  * The state transition matrix (`F` in Wikipedia notation) is the
//    identity, meaning that the modeled system is constant.
//  * The observation matrix (`H` in Wikipedia notation) is a 1x2 vector set as
//    `[frame_size_delta_bytes, 1.0]`.
//  * The process noise covariance (`Q`) is diagonal and constant.
//  * The observation noise covariance (`r`) is determined externally by the
