...
#ifndef MODULES_VIDEO_CODING_RTP_VIDEO_DEPACKETIZER_RAW_H_
#define MODULES_VIDEO_CODING_RTP_VIDEO_DEPACKETIZER_RAW_H_
...
// Uses rtp header extensions to determine frame boundaries.
...
#endif  // MODULES_VIDEO_CODING_RTP_VIDEO_DEPACKETIZER_RAW_H_
