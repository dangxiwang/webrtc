...
class MonitorInterval {
 public:
  ...
  const std::vector<TimeDelta>& GetReceivedPacketsRtt() const;
  const std::vector<Timestamp>& GetReceivedPacketsSentTime() const;
  const std::vector<Timestamp>& GetLostPacketsSentTime() const;
