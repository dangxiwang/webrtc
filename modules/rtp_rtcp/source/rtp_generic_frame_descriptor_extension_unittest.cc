...
// TODO(danilchap): Add fuzzer to test for various invalid inputs: there are
// too many possibilities to cover them with unit tests.

TEST(RtpGenericFrameDescriptorExtensionTest, ParseFirstSubFrameInFrame) {
  constexpr uint8_t kRaw[] = {0x80};
...
TEST(RtpGenericFrameDescriptorExtensionTest,
  ...
  constexpr uint8_t kRaw[] = {0x20 | kTemporalLayer, 0x49, 0x12, 0x34};
  RtpGenericFrameDescriptor descriptor;
...
TEST(RtpGenericFrameDescriptorExtensionTest, ParseMinShortFrameDependencies) {
  ...
  constexpr uint8_t kRaw[] = {0x28, 0x01, 0x00, 0x00, 0x04};
  RtpGenericFrameDescriptor descriptor;
...
TEST(RtpGenericFrameDescriptorExtensionTest, ParseMaxShortFrameDependencies) {
  ...
  constexpr uint8_t kRaw[] = {0x28, 0x01, 0x00, 0x00, 0xfc};
  RtpGenericFrameDescriptor descriptor;
...
TEST(RtpGenericFrameDescriptorExtensionTest, ParseMinLongFrameDependencies) {
  ...
  constexpr uint8_t kRaw[] = {0x28, 0x01, 0x00, 0x00, 0x02, 0x01};
  RtpGenericFrameDescriptor descriptor;
...
TEST(RtpGenericFrameDescriptorExtensionTest,
  ...
  constexpr uint8_t kRaw[] = {0x28, 0x01, 0x00, 0x00, 0x54 | 0x02, 0x76};
  RtpGenericFrameDescriptor descriptor;
...
TEST(RtpGenericFrameDescriptorExtensionTest, ParseMaxLongFrameDependencies) {
  ...
  constexpr uint8_t kRaw[] = {0x28, 0x01, 0x00, 0x00, 0xfe, 0xff};
  RtpGenericFrameDescriptor descriptor;
...
TEST(RtpGenericFrameDescriptorExtensionTest, ParseTwoFrameDependencies) {
  ...
  constexpr uint8_t kRaw[] = {
      0x28, 0x01, 0x00, 0x00, (kDiff1 << 2) | 0x01, kDiff2 << 2};
  RtpGenericFrameDescriptor descriptor;
