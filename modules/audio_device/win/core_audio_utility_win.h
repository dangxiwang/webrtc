...
// by using the rtc_base::win::ScopedCOMInitializer helper class.
...
class WaveFormatWrapper {
 public:
  explicit WaveFormatWrapper(WAVEFORMATEXTENSIBLE* p)
      : ptr_(reinterpret_cast<WAVEFORMATEX*>(p)) {}
  explicit WaveFormatWrapper(WAVEFORMATEX* p) : ptr_(p) {}
