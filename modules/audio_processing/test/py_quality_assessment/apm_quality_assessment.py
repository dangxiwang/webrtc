...
def _ValidateArguments(args, parser):
  ...
  if args.external_vad_names is None:
    args.external_vad_names = []
  if args.external_vad_paths is None:
    args.external_vad_paths = []
  if len(args.external_vad_names) != len(args.external_vad_paths):
    parser.error('If provided, --external_vad_paths and --external_vad_names must '
...
def main():
  ...
  simulator = simulation.ApmModuleSimulator(
      ...
      external_vads=external_vad.ExternalVad.ConstructVadList(
          rnargs.external_vad_paths, args.external_vad_names))
  simulator.Run(
