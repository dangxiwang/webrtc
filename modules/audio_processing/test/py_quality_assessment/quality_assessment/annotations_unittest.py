...
class TestAnnotationsExtraction(unittest.TestCase):
  ...
  _MAX_VAD_TYPE = (_VAD_TYPE_CLASS.ENERGY_THRESHOLD |
  ...
  def testFrameSizes(self):
    e = annotations.AudioAnnotationsExtractor(self._MAX_VAD_TYPE)
  ...
  def testVoiceActivityDetectors(self):
    for vad_type_value in range(0, self._MAX_VAD_TYPE+1):
  ...
  def testFakeExternalSaveLoad(self):
    def FakeExternalFactory():
      return annotations.AudioAnnotationsExtractor.ExternalVad(
        os.path.join(
