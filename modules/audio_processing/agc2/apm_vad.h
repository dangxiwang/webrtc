...
#ifndef MODULES_AUDIO_PROCESSING_AGC2_APM_VAD_H_
#define MODULES_AUDIO_PROCESSING_AGC2_APM_VAD_H_
...
class ApmVad : public VadWithLevel {
 public:
  ...
  std::vector<LevelAndProbability> AnalyzeFrame(
...
#endif  // MODULES_AUDIO_PROCESSING_AGC2_APM_VAD_H_
