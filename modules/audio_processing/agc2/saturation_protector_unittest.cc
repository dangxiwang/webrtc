...
float RunOnConstantLevel(int num_iterations,
  ...
  for (int i = 0; i < num_iterations; ++i) {
    saturation_protector->UpdateMargin(vad_data,  // By copy
...
TEST(AutomaticGainController2SaturationProtector,
  ...
  // Want to test the delay behavior. Probably make a delayed change
  // in RMS / peak. Change happens kFullBufferSizeMs later to the
  // RMS. What should we test?? That the level estimator doesn't change much?
