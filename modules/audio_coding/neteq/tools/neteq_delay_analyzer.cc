...
void NetEqDelayAnalyzer::CreateMatlabScript(
  ...
  PrintDelays(corrected_arrival_delay_ms, kArrivalDelayX, kArrivalDelayY,
              output);

  // PrintDelays(corrected_arrival_delay_x, kCorrectedArrivalDelayX,
  // kCorrectedArrivalDelayY, output);

  PrintDelays(playout_delay_ms, kPlayoutDelayX, kPlayoutDelayY, output);

  PrintDelays(target_delay_ms, kTargetDelayX, kTargetDelayY, output);
