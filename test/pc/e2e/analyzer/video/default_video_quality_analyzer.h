...
struct StreamCodecInfo {
  ...
  // Timestamp when this codec was used first time.
...
struct StreamStats {
  ...
  // Vectors of decoder used for this stream by receiving client.
...
class DefaultVideoQualityAnalyzer : public VideoQualityAnalyzerInterface {
 ...
 private:
  ...
  struct FrameStats {
    ...
    absl::optional<StreamCodecInfo> used_encoder;
    // Can be not set if frame was dropped in the network.
    absl::optional<StreamCodecInfo> used_decoder;
  };
  ...
  class FrameInFlight {
   ...
   private:
    ...
    // Can be not set if frame was dropped by encoder.
    absl::optional<StreamCodecInfo> used_encoder_;
