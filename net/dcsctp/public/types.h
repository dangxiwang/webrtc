...
// `DcSctpSocketCallbacks::OnLifecycleEnd` will be called to indicate that the
// lifecycle isn't tracked any longer. The value zero (0) is not a valid
// lifecycle identifier, and will be interpreted as not having it set.
class LifecycleId
