...
TEST(IForwardTsnChunkTest, FromCapture) {
  ...
  */
  ...
  EXPECT_THAT(
      ...
      ElementsAre(IForwardTsnChunk::SkippedStream(StreamID(1), false, MID(2))));
}

TEST(IForwardTsnChunkTest, SerializeAndDeserialize) {
  IForwardTsnChunk chunk(
      TSN(123), {IForwardTsnChunk::SkippedStream(StreamID(1), false, MID(23)),
                 IForwardTsnChunk::SkippedStream(StreamID(42), true, MID(99))});
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          IForwardTsnChunk::SkippedStream(StreamID(1), false, MID(23)),
          IForwardTsnChunk::SkippedStream(StreamID(42), true, MID(99))));
