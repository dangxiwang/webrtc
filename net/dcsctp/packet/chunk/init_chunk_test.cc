...
TEST(InitChunkTest, SerializeAndDeserialize) {
  InitChunk chunk(/*initiate_tag=*/123, /*a_rwnd=*/456,
                  /*nbr_outbound_streams=*/65535,
                  /*nbr_inbound_streams=*/65534, /*initial_tsn=*/789,
  ...
  EXPECT_EQ(deserialized.initiate_tag(), 123u);
  ...
  EXPECT_EQ(deserialized.initial_tsn(), 789u);
