...
def recipe(recipe, repo = "infra/recipe_bundles/chromium.googlesource.com/chromium/tools/build"):
    return luci.recipe(
        name = recipe.split("/")[-1],
        cipd_package = repo,
...
recipe("lkgr_finder", repo = "infra/recipe_bundles/chromium.googlesource.com/infra/infra")
...
def merge_dicts(a, b):
    ...
    If matching entries are both dicts or both lists, they will be merged (non-recursively).
...
android_try_job("android_compile_arm_dbg", cq = False)
...
android_try_job("android_compile_arm64_dbg", cq = False)
android_try_job("android_arm64_dbg", cq = False)
...
android_try_job("android_compile_x64_rel", cq = False)
...
linux_try_job("linux_dbg", cq = False)
...
mac_try_job("mac_dbg", cq = False)
mac_try_job("mac_compile_dbg")
mac_builder("Mac64 Release", "Mac|x64|rel")
mac_try_job("mac_rel")
mac_try_job("mac_compile_rel", cq = False)
...
win_try_job("win_x64_clang_dbg", cq = False)
win_try_job("win_x64_clang_dbg_win8", cq = False)
win_try_job("win_x64_clang_dbg_win10", cq = False)
win_try_job("win_compile_x64_clang_dbg")
win_builder("Win64 Release (Clang)", "Win Clang|x64|rel")
win_try_job("win_x64_clang_rel", cq = False)
win_try_job("win_compile_x64_clang_rel")
win_builder("Win32 ASan", "Win Clang|x86|asan")
win_try_job("win_asan")
win_builder("Win64 UWP", ci_cat = None, fyi_cat = "")
win_try_job("win_x64_uwp", cq = False, try_cat = None, fyi_cat = "")
