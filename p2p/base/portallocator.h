...
class PortAllocator : public sigslot::has_slots<> {
 public:
  ...
  // Set IceCredentialsFactory that is used when creating pooled sessions.
  virtual void SetIceCredentialsFactory(
 ...
 protected:
  ...
  // Create/consume ice credentials (ufrag/passwd) when pooling sessions.
  IceParameters CreateIceCredentials();
  void ConsumeIceCredentials(IceParameters);
