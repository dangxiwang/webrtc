...
class P2PTransportChannelTestBase : public ::testing::Test,
 ...
 public:
  P2PTransportChannelTestBase()
      : vss_(new rtc::VirtualSocketServer()),
        ...
        packet_socket_factory_(ss_.get()),
        main_(ss_.get()),
    ...
    ep1_.allocator_ = CreateBasicPortAllocator(
        &ep1_.network_manager_, &packet_socket_factory_, stun_servers,
        kTurnUdpIntAddr, rtc::SocketAddress());
    ep2_.allocator_ = CreateBasicPortAllocator(
        &ep2_.network_manager_, &packet_socket_factory_, stun_servers,
        kTurnUdpIntAddr, rtc::SocketAddress());
 ...
 protected:
  ...
  rtc::BasicPacketSocketFactory* packet_socket_factory() {
...
class P2PTransportChannelMostLikelyToWorkFirstTest
 ...
 public:
  P2PTransportChannelMostLikelyToWorkFirstTest()
    ...
    allocator_ = CreateBasicPortAllocator(
...
TEST(P2PTransportChannelResolverTest, HostnameCandidateIsResolved) {
  ...
  rtc::BasicPacketSocketFactory socket_factory(&vss);
  FakePortAllocator allocator(rtc::Thread::Current(), &socket_factory);
  auto channel =
...
TEST(P2PTransportChannel, InjectIceController) {
  ...
  rtc::VirtualSocketServer vss;
  rtc::BasicPacketSocketFactory socket_factory(&vss);
  FakePortAllocator pa(rtc::Thread::Current(), &socket_factory);
