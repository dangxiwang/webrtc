...
class AndroidVideoBuffer : public AndroidVideoFrameBuffer {
 public:
  ...
  // called when the return AndroidVideoBuffer is destroyed.
  static rtc::scoped_refptr<AndroidVideoBuffer> AdoptJavaVideoBuffer(
      JNIEnv* jni,
      jobject j_video_frame_buffer);
 ...
 protected:
  ...
  // Create() or AdoptJavaVideoBuffer() instead for clarity.
