...
class ParsedRtcEventLog {
 ...
 public:
  ...
  struct IceCandidatePairConfig {
    ...
    rtclog::IceCandidatePairConfig::IceCandidateType local_candidate_type;
    rtclog::IceCandidatePairConfig::NetworkType local_network_type;
    rtclog::IceCandidatePairConfig::IceCandidateType remote_candidate_type;
    rtclog::IceCandidatePairConfig::Protocol candidate_pair_protocol;
    rtclog::IceCandidatePairConfig::Protocol local_relay_protocol;
    rtclog::IceCandidatePairConfig::Protocol remote_relay_protocol;
    rtclog::IceCandidatePairConfig::AddressFamily candidate_pair_address_family;
  };
