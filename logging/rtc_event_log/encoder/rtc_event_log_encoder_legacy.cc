...
ConvertIceCandidatePairConfigType(IceCandidatePairConfigType type) {
  switch (type) {
    ...
    case IceCandidatePairConfigType::kPruned:
      return rtclog::IceCandidatePairConfig::PRUNED;
...
std::string RtcEventLogEncoderLegacy::EncodeIceCandidatePairConfig(
  ...
  encoded_ice_event->set_type(ConvertIceCandidatePairConfigType(event.type_));
  ...
  encoded_ice_event->set_remote_relay_protocol(
      ConvertIceCandidatePairProtocol(desc.remote_relay_protocol));
  encoded_ice_event->set_candidate_pair_address_family(
      ConvertIceCandidatePairAddressFamily(desc.candidate_pair_address_family));
