...
class IceCandidatePairDescription {
 public:
  ...
  std::string media_content;
  std::string local_candidate_type;
  std::string local_candidate_protocol;
  std::string local_transport_address;
  std::string local_network_type;
  std::string remote_candidate_type;
  std::string remote_candidate_protocol;
  std::string remote_transport_address;
};
