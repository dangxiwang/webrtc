...
TEST_P(SvcSelectLayerTest, CheckDecodeSelectedLayer) {
  ...
  EmulatedSFUConfig emulated_sfu_config(target_spatial_index,
  ...
  auto fixture = CreateTestFixture(
      ...
      *network_emulation_manager->time_controller(),
      ...
      [this, emulated_sfu_config, scalability_mode_str](PeerConfigurer* alice) {
        VideoConfig video(/*stream_label=*/"alice-video", /*width=*/1850,
                          /*height=*/1110, /*fps=*/30);
        video.emulated_sfu_config = emulated_sfu_config;
