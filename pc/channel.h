...
class BaseChannel : public ChannelInterface,
 ...
 public:
  ...
  MediaChannel* media_channel() const override {
    if (!worker_thread_->IsCurrent()) {
      RTC_LOG(LS_ERROR) << "DEBUG: media_channel() thread jump";
      return worker_thread_->Invoke<MediaChannel*>(
          RTC_FROM_HERE, [this] { return media_channel(); });
    }
 ...
 private:
  ...
  // thread.
  std::unique_ptr<MediaChannel> media_channel_ RTC_GUARDED_BY(worker_thread());
