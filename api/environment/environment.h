...
// Environment is an input parameter that doesn't change for the duration of the
// peer connection. Usually Environment should be the first parameter in the
// constructor or factory, and first member in the class. Keeping Environment as
// first member in the class ensures utilities (e.g. clock) are still valid
// during destruction of other members.
//
// Example:
