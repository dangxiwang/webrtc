...
class RTC_EXPORT PeerConnectionInterface : public webrtc::RefCountInterface {
 public:
  ...
  // Allows an application to reconfigure and restart bandwidth estimation.
  // Can be called both before and after ICE is connected.
  virtual void RestartBandwidthEstimation(
