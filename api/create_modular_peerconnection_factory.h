...
#ifndef WEBRTC_MODULAR_PEER_CONNECTION_FACTORY_DECLARED
#define WEBRTC_MODULAR_PEER_CONNECTION_FACTORY_DECLARED
// TODO(bugs.webrtc.org/9862): The following 3 declarations of
// CreateModularPeerConnectionFactory are also available in the header
// in api/peerconnectioninterface.h but they should always be included
// from this header because declarations will be removed from
// api/peerconnectioninterface.h as soon after the deprecation period ends.
...
#endif  // WEBRTC_MODULAR_PEER_CONNECTION_FACTORY_DECLARED
