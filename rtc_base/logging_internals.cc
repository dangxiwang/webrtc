...
std::ostream& GetNoopStream() {  // no-presubmit-check TODO(webrtc:8982)
  class NoopStreamBuf : public std::streambuf {
   public:
    int overflow(int c) override { return c; }
  };
  static NoopStreamBuf noop_buffer;
  static std::ostream  // no-presubmit-check TODO(webrtc:8982)
      noop_stream(&noop_buffer);
  return noop_stream;
}
...
std::ostream& LogMessage::stream() {  // no-presubmit-check TODO(webrtc:8982)
