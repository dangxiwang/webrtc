...
// On Android, pthread_condattr_setclock is available from version 21.
// By default, we target a new enough version for 64-bit platforms but
// not for 32-bit platforms.
#if (defined(WEBRTC_ANDROID) && __ANDROID_API__ < 21) || \
